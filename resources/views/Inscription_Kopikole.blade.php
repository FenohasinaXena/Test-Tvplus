            ...
            <div class="row ">
               <div class="col-md-6" style="margin-top: 90px;">
                  <div class="titlepage text_align_left">
                     <h2>S'inscrire Kopi Kole</h2>
                  </div>
                  @if (session('message'))
                     <p class="text-success mb-1"><Strong>{{ session('message') }}</Strong></p> 
                  @endif
                <form action="/inscri_kopikole" method="post">
                  @csrf
                    <div id="request" class="main_form">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <label for="">Chanteur imité (Mpihira ho alaina tahaka) <span class="text-danger">*</span></label>
                            <input class="contactus"  type="text" name="chanteurimite" required> 
                        </div>
                        <div class="col-md-12">
               ...
               <div class="col-md-6 "style="margin-top: 200px;">
                  <div id="request" class="main_form">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                            <label for="">03 Titres de Chansons de l’artiste (Lohateny telo @ hiran’ily Mpihira ho alainao tahaka)  <span class="text-danger">*</span></label>
